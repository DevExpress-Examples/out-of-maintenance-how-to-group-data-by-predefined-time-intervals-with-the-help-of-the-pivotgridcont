...
Namespace ChartMonthSum
	Partial Public Class Form1
		...
		Private Sub CreatePivotGrid()
			...
			Me.pivotGridControl1.OptionsChartDataSource.ShowColumnTotals = False
			Me.pivotGridControl1.OptionsChartDataSource.ShowRowTotals = False
			Me.pivotGridControl1.OptionsChartDataSource.ShowColumnGrandTotals = False
		...
		Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
			...
			' Adjust AxisX
			TryCast(chartControl1.Diagram, XYDiagram).AxisX.DateTimeOptions.Format = DateTimeFormat.ShortDate
			TryCast(chartControl1.Diagram, XYDiagram).AxisX.DateTimeMeasureUnit = DateTimeMeasurementUnit.Month
